...
//  $('#map').mapster('resize',auto,100%);
  ...
  function rgb2hex(rgb) {
    console.log("inside rgb to hex");

    //rgb gets fucked up after INTROJS, this is a bandaid.
    if ( (rgb.match(/,/g) || []).length == 3){
      console.log("we gotta remov esome things");
      console.log(rgb.substring(0, rgb.lastIndexOf(',')) + ")");
